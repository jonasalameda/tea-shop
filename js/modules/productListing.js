...
function parseProducts(products) {
  ...
  products.products.forEach((product) => {
    ...
    const cardActions = createCustomElement(productCard, "div", "");
    cardActions.classList =
      "card-footer d-flex justify-content-center align-items-center";

    const btnViewDetails = createCustomElement(
      cardActions,
      "button",
      "View details"
    );
    ...
    const btnAddToCart = createCustomElement(
      cardActions,
      "button",
      "Add to cart"
    );
    btnAddToCart.classList = "btn btn-primary add-cart mx-3";
